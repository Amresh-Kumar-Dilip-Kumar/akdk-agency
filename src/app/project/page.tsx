                                ...
                                <CarouselContent>
                                    {
                                        project.image.map((url, imgIndex) => (
                                            <CarouselItem key={imgIndex}>
                                                <Image src={url} alt={project.title} className="rounded-lg shadow-lg w-full max-w-sm sm:max-w-md md:max-w-full transition-transform duration-300 transform hover:scale-105" width={500} height={300} />
                                            </CarouselItem>
                                        ))
                                    }
                                </CarouselContent>
