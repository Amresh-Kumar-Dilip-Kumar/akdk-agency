  ...
  const slides = [
    {
      ...
      description:
        "We build scalable and feature-rich web applications tailored to your needs.",
      image: "/custom.jpg",
    },
    {
      title: "Seamless Upgrades",
      description:
        "Keep your web apps up-to-date with the latest technologies and enhancements.",
      image: "/seamlessupgrade.webp",
    },
    {
      title: "Ongoing Support",
      description:
        "We provide long-term support and maintenance for smooth app performance.",
      image: "/serv-1.jpg",
    },
  ];
              ...
              <div className="w-full md:w-1/2 p-8">
                ...
                <div className="flex flex-wrap items-center -m-7 px-4">
                  ...
                  <div className="w-full md:w-auto p-7 flex space-x-4">
                    ...
                    <button
                      onClick={() =>
                        setActiveSlide((prev) => Math.min(prev + 1, slideCount))
                      }
