            ...
            <div className="w-full max-w-[1440px] mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-3">
                            <li>
                                <Link href="/about-us" className="hover:text-orange-400 transition-colors">About Us</Link>
                            </li>
                            <li>
                                <Link href="/service" className="hover:text-orange-400 transition-colors">Services</Link>
                            </li>
                            <li>
                                <Link href="/project" className="hover:text-orange-400 transition-colors">Portfolio</Link>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-3">
                            <li>
                                <Link href="/contact-us" className="hover:text-orange-400 transition-colors">Contact</Link>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-3">
                            <li>
                                <Link href="/" passHref>
                                    <span className="hover:text-orange-400 transition-colors">Menu 1</span>
                                </Link>
                           </li>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center text-gray-60000 text-sm  *:flex-1">
                    ...
                    <div className="flex space-x-6 mt-4 md:mt-0 justify-center">
                        <Link href="/tmcd" className="hover:text-orange-400 transition-colors">Terms and Conditions</Link>
